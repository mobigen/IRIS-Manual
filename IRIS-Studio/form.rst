...
.. image:: ./studio/images/combo/studio_combo_42_1.png.png
    :scale: 100 %
    :alt: 이벤트값 전달 설정
...
| 콤보 박스와 동일합니다.
| 데이터 설정은 챠트의 `데이터설정 Mhttp://docs.iris.tools/manual/IRIS-Manual/IRIS-Studio/data_visualize.html#id1>`__ 을 참고하시기 바랍니다.
